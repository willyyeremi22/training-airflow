...
def main():
    ...
    data = read_sql(sql=f"select * from literature_reference limit 100",con=engine,chunksize=10)
    for i, chunk in enumerate(data):
        chunk.to_csv(f"{OUTPUT_DIRECTORY}/rfam__literature_reference.csv", mode="a", header=(i==0), index=False)
